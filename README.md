...
- [pdfmux](https://github.com/NameetP/pdfmux) - PDF extraction that audits every page. Routes to the best of 5 backends (PyMuPDF, RapidOCR, Docling, Gemini Flash), re-extracts failures automatically. #2 on opendataloader-bench. Includes structured extraction, heading detection, and confidence scoring.
